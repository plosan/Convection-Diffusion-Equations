...
\begin{picture}(6802.00,6802.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(3263,6070){\makebox(0,0){\strut{}\textbf{Diagonal flow} $(\mathrm{Pe} = 1)$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={340.10bp},height={340.10bp}]{figures/case_diagonal_flow/diagonal_N200_Pe1.0e+00}}%
    \gplfronttext
  \end{picture}%
\endgroup
