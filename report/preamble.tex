...
\lhead{Gas Dynamics and Heat and Mass Transfer\\Numerical Solution of the Convection--Diffusion Equations}
\rhead{\includegraphics[trim={0.55cm 0.90cm 0.65cm 0.85cm},clip, width=4cm]{figures/00_general/logo_eseiaat.pdf}}
\cfoot{\thepage}
