...
To finish with the general theory, we would like to know whether the solution of
...
\begin{theorem}[Infinite differentiability in the interior] \label{teo:infinite_differentiability_interior}
	Assume
	\[
