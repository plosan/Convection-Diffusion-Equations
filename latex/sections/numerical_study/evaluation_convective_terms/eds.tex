...
% \begin{align}
% 	\phi_w &= 
% 	\left( 1 - \frac{e^{\peclet_w \frac{d_{Ww}}{d_{PW}}} - 1}{e^{\peclet_w} - 1} \right)
% 	 \phi_W + 
% 	\frac{e^{\peclet_w \frac{d_{Ww}}{d_{PW}}} - 1}{e^{\peclet_w} - 1} \phi_P \\
% 	\phi_n - \phi_P &= 
% 	\frac{e^{\peclet_n \frac{d_{Pn}}{d_{PN}}} - 1}{e^{\peclet_n} - 1} (\phi_N - \phi_P) \\
% 	\phi_s &= 
% 	\left( 1 - \frac{e^{\peclet_s \frac{d_{Ss}}{d_{PS}}} - 1}{e^{\peclet_s} - 1} \right)
% 	\phi_S + 
% 	\frac{e^{\peclet_s \frac{d_{Ss}}{d_{PS}}} - 1}{e^{\peclet_s} - 1} \phi_P
% 	\label{eq:eds_s}	
% \end{align}