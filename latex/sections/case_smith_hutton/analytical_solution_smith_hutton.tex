...
not it is important for the behaviour of the solution. In view of the PDE from
\eqref{eq:smith_hutton_cauchy_problem}, it seems that the solution shall be
governed by the quotient $\rho / \Gamma$. Due to the nature of the problem, the
velocity field and the mixed boundary conditions (both Dirichlet and Neumann)

\subsubsection{Analytical solution for \texorpdfstring{$\rho / \Gamma =
