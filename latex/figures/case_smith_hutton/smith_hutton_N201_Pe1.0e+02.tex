...
\begin{picture}(7370.00,3968.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(3554,3608){\makebox(0,0){\strut{}\textbf{Smith--Hutton case} $(\rho / \Gamma = 10^{2})$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={368.50bp},height={198.40bp}]{figures/case_smith_hutton/smith_hutton_N201_Pe1.0e+02}}%
    \gplfronttext
  \end{picture}%
\endgroup
