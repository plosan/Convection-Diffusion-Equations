...
\begin{picture}(4534.00,4534.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(2243,3916){\makebox(0,0){\strut{}\textbf{Diagonal case} $(\mathrm{Pe} = 10^{3})$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={226.70bp},height={226.70bp}]{figures/case_diagonal_flow/diagonal_N200_Pe1.0e+03}}%
    \gplfronttext
  \end{picture}%
\endgroup
